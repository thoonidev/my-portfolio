      ...
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center px-4 sm:px-6 md:px-10 py-16">
        ...
        <div className="flex flex-col md:w-1/2 text-center md:text-left items-center md:items-start space-y-6">
          ...
          <p className="text-base leading-relaxed max-w-md">
            Experiencia en desarrollo web y aplicaciones personalizadas. Busco
            crear soluciones eficientes, escalables y centradas en el usuario.
            Disfruto trabajar con tecnologías modernas y siempre busco aprender
            y mejorar cada día.
          </p>
